...
datablock staticShapeData(BloodDecal1) {
	shapeFile = $SMM::Path @ "res/shapes/decals/blood1.dts";
...
datablock staticShapeData(BloodDecal2) {
	shapeFile = $SMM::Path @ "res/shapes/decals/blood2.dts";
...
datablock ParticleData(bloodParticle)
{
	...
	textureName		= $SMM::Path @ "res/shapes/decals/blood2.png";
	//animTexName		= " ";
...
datablock ParticleData(bloodParticle2)
{
	...
	textureName		= $SMM::Path @ "res/shapes/decals/blood3.png";
	//animTexName		= " ";
